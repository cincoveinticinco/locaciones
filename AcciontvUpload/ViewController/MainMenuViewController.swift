...
//        }
    ...
    // MARK: - Miscellaneous
    func startRequest() {
        let accionRequest = AccionRequest("POST", [AccionRequest.AccionKey.Session:token!], "/api/saml/validate_session")
    ...
    func closeSession() {
        ...
        let url = URL(string: "\(serverURL!)/api/saml/logout/\(token!)")!
